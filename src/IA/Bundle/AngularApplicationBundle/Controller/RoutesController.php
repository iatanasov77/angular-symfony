    ...
    public function indexAction()
    {
        $result = array(
            "routes" => array(
                    ...
                    array("name" => "/add-page", "templateUrl" => "/bundles/iacms/js/templates/editPage.html", "controller" => "EditPageController", "isFree" => true),
                    array("name" => "/edit-page/:id", "templateUrl" => "/bundles/iacms/js/templates/editPage.html", "controller" => "EditPageController", "isFree" => true),
            ),
            "default" => "/contacts"
        );
