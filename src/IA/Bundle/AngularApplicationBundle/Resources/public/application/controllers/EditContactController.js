...
define([], function() {
    function EditContactController($rootScope, $scope, $location, $routeParams, contactsService) {
    ...
    EditContactController.$inject=['$rootScope', '$scope', '$location', '$routeParams', 'contactsService'];
